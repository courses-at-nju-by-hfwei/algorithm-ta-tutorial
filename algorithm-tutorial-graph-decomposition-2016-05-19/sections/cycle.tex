...
\begin{frame}{Cycle detection}
  \begin{table}[ht]
    ...
    \begin{tabular}{c||c|c}
     ...
     DFS 	& back edge $\iff$ cycle 	& back edge $\iff$ cycle \\ \hline
     BFS	& \begin{tabular}[c]{@{}l@{}}back edge $\Rightarrow$ cycle\\ cycle $\nRightarrow$ back edge \end{tabular} & cross edge $\iff$ cycle  \\ \hline
    \end{tabular}
  \end{table}

  \begin{alertblock}{Remark.}
    \begin{itemize}
      \item cycle in undirected graphs
      \item cycle in digraphs
	\begin{itemize}
	  \item DAG
	  \item SCC
	\end{itemize}
