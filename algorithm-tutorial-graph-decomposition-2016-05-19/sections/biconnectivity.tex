...
\begin{frame}{Biconnectivity algorithm}
  ...
  \begin{exampleblock}{Root of DFS tree as an articulation point \pno{3.4.8}}
...
%%%%%%%%%%%%%%%
\begin{frame}{Biconnectivity algorithm}
  \begin{exampleblock}{Articulation checking, 1971 \pno{3.4.10}}
...
%%%%%%%%%%%%%%%
\begin{frame}{Biconnectivity algorithm}
  \begin{exampleblock}{Initialization of $\text{back}[v]$, 1971 \pno{3.4.9}}
    \begin{center}
