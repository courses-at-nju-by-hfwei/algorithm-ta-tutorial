...
% \titlegraphic{\includegraphics[height = 1.5cm]{figs/qrcode-alg-ta-20170531.png}}
\institute{hfwei@nju.edu.cn}
\date{May 26, 2017 -- May 31, 2017}
...
\input{sections/cut-cycle-prop}
\input{sections/mst-time}
\input{sections/variant-mst}
