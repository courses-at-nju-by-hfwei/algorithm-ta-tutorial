...
\begin{frame}{}
  ...
  \pause
  \vspace{0.30cm}
  \centerline{\red{\fbox{$Q:$ $\forall v,$ computing $\text{impact}(v)$}}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  \pause
  \fig{width = 0.40\textwidth}{figs/2sat-implication-graph.pdf}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  %     \fig{width = 0.80\textwidth}{figs/2sat-implication-graph-wiki.png}
  %     \fig{width = 0.80\textwidth}{figs/2sat-implication-graph.pdf}
  %   \column{0.50\textwidth}
  %     \pause
  %     \fig{width = 0.80\textwidth}{figs/2sat-implication-graph.png}
  % \end{columns}

  \fig{width = 0.50\textwidth}{figs/2sat-implication-graph.png}
  \begin{theorem}[2SAT]
    \[
