% file: parts/decision-tree.tex

%%%%%%%%%%%%%
\begin{frame}{}
  \centerline{\teal{\Large Decision Tree}}

  \fig{width = 0.50\textwidth}{figs/decision-tree-model}
\end{frame}
%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \fig{width = 0.80\textwidth}{figs/decision-tree-insertion-sort}
  \centerline{The decision tree for \teal{\uncover<2->{insertion} sort} on three elements.}
\end{frame}
%%%%%%%%%%%%%%%
