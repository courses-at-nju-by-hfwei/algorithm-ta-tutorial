...
\begin{frame}{}
  \begin{exampleblock}{Application of Cut Property \pno{$10.15\; (3)$}}
	\centerline{$e = (u,v) \in G$ is \red{a} lightest edge $\implies$ $e \in \exists$ MST of $G$}
  \end{exampleblock}
  ...
  \begin{exampleblock}{Application of Cut Property \pno{$10.15\; (4)$}}
	\centerline{$e = (u,v) \in G$ is \red{the} unique lightest edge $\implies$ $e \in \forall$ MST}
  \end{exampleblock}
\end{frame}
%%%%%%%%%%%%%
...
\begin{frame}<presentation:0>[noframenumbering]
  ...
  \pause
  \vspace{0.30cm}
  \fig{width = 0.40\textwidth}{figs/divide-conquer-mst-counterexample.pdf}
\end{frame}
%%%%%%%%%%%%%
