...
\begin{frame}[fragile]{}
  ...
  \pause
  \vspace{0.50cm}
  \fignocaption{width = 0.40\textwidth}{figs/kidding}
\end{frame}
%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \centerline{\teal{\large \only<1>{A Little}\only<2->{\red{\bf More}} Mathematics for Computer Science}}

  \uncover<2->{
    \begin{columns}
      \column{0.50\textwidth}
	\fignocaption{width = 0.50\textwidth}{figs/concrete-mathematics}
      \column{0.50\textwidth}
