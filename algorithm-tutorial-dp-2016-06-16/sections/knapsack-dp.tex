...
\begin{frame}{The knapsack problem}
  \begin{exampleblock}{The changing-making problem \pno{2.2.17 (b), 2.2.4 (subset sum)}}
    \begin{itemize}
...
%%%%%%%%%%
\begin{frame}{The knapsack problem}
  \begin{exampleblock}{The changing-making problem \pno{2.2.17 (a)}}
    \begin{itemize}
      \item coins values: $x_{1} \dots x_{n}$
      \item amount: $v$
      \item possible to make change for $v$?
...
%%%%%%%%%%
\begin{frame}{The knapsack problem}
  \begin{exampleblock}{The changing-making problem \pno{2.2.17 (c)}}
    \begin{itemize}
      \item coins values: $x_{1} \dots x_{n}$
      \item amount: $v$
      \item possible to make change for $v$?
